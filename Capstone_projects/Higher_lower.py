...
def random_account(instagram_account):
    name = instagram_account['name']
    no_followers = instagram_account['follower_count']
    description = instagram_account['description']    
...
def game():
    score = 0
    instagram_account1 = get_account()
    ...
    while game_over == False:
        ...
        elif guess_follower_count == 'B':
            guess = instagram_account2['follower_count']
            

        answer = compare_followers(no_followers1,no_followers2) 
        if guess == answer:
            print(f"it's correct, {guess} is the answer")
            score+=1
            person1 = person2
            print(person1)
            instagram_account2 = get_account()
